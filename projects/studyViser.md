...
The project was built using modern full-stack web development technologies including Next.js and React for the frontend, Bootstrap 5 and React Bootstrap for responsive UI design, and PostgreSQL with Prisma for database management. Authentication was implemented using NextAuth.js, while React Hook Form was used to manage user input and form validation.

Working on StudyViser helped me gain experience in full-stack application development, collaborative software engineering, and agile team workflows. I also developed a better understanding of designing responsive user interfaces, handling authentication systems, and integrating frontend and backend technologies into a complete web application.
